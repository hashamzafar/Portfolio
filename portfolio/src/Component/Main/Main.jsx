    ...
    <>
      ...
      <Jumbotron className="background" id="jumbo">
        <div className="bg-text  p-5 ">
          ...
          <hr />
          <p>
            As a fully motivated full stack developer, I am ready to pave my way
            in all areas of this field and explore visual design and technical
            implementation with a well built team. My core goal is to learn from
            all aspects and explicitly deliver details on how the application
            looks and works.{" "}
          </p>
