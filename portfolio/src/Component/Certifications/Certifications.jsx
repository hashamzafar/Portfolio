...
const Certifications = () => {
  return (
    ...
    <div className="section-bg">
      <Row className=" p-5 justify-content-center d-flex ">
        <Col sm={6} md={6} lg={3} className="my-5">
          <Card style={{ width: "34em" }} className="card-col ">
            <Card.Body >
        ...
        <Col/>
        <Col sm={6} md={8} lg={8}className="my-5">
          <Carousel fade id="certifications" interval={1000}className="slide">
            <Carousel.Item >
              <img
